...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = polygon_area_calculator.Rectangle(3, 6)
        self.sq = polygon_area_calculator.Square(5)

    def test_subclass(self):
        actual = issubclass(polygon_area_calculator.Square,
                            polygon_area_calculator.Rectangle)
        expected = True
        self.assertEqual(
            actual, expected,
    ...
    def test_distinct_classes(self):
        actual = polygon_area_calculator.Square is not polygon_area_calculator.Rectangle
        expected = True
        self.assertEqual(
            actual, expected,
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, polygon_area_calculator.Square) and isinstance(
            self.sq, polygon_area_calculator.Square)
        expected = True
        self.assertEqual(
            actual, expected,
    ...
    def test_get_amount_inside_two_rectangles(self):
        rect2 = polygon_area_calculator.Rectangle(4, 8)
    ...
    def test_get_amount_inside_none(self):
        rect2 = polygon_area_calculator.Rectangle(2, 3)
        actual = rect2.get_amount_inside(self.rect)
        expected = 0
        self.assertEqual(actual, expected,
